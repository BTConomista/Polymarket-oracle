...
- [ ] **Test** — mantieni `pytest` verde (**980 verdi** al 28/07/2026); aggiungi
...
python -m pytest                       # test (980 verdi al 28/07/2026)
```
...
tests/           test unitari (980 verdi al 28/07/2026), fra cui i guardiani
