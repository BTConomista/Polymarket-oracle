...
- [ ] **Test** — mantieni `pytest` verde (**913 verdi** al 28/07/2026); aggiungi
...
python -m pytest                       # test (913 verdi al 28/07/2026)
```
...
tests/           test unitari (913 verdi al 28/07/2026), fra cui i guardiani
