...
- [ ] **Test** — mantieni `pytest` verde (**1.289 verdi** al 02/08/2026); aggiungi
...
python -m pytest                       # test (1.289 verdi al 02/08/2026)
```
...
tests/           test unitari (1.289 verdi al 02/08/2026), fra cui i guardiani
