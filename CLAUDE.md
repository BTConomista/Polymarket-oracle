...
- [ ] **Test** — mantieni `pytest` verde (**1.312 verdi** al 03/08/2026); aggiungi
...
python -m pytest                       # test (1.312 verdi al 03/08/2026)
```
...
tests/           test unitari (1.312 verdi al 03/08/2026), fra cui i guardiani
