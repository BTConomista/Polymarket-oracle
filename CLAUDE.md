...
- [ ] **Test** — mantieni `pytest` verde (**889 verdi** al 28/07/2026); aggiungi
...
python -m pytest                       # test (889 verdi al 28/07/2026)
```
...
tests/           test unitari (889 verdi al 28/07/2026), fra cui i guardiani
