...
- [ ] **Test** — mantieni `pytest` verde (**991 verdi** al 28/07/2026); aggiungi
...
python -m pytest                       # test (991 verdi al 28/07/2026)
```
...
tests/           test unitari (991 verdi al 28/07/2026), fra cui i guardiani
