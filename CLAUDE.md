...
- [ ] **Test** — mantieni `pytest` verde (**1.416 verdi** al 05/08/2026); aggiungi
...
python -m pytest                       # test (1.416 verdi al 05/08/2026)
```
...
tests/           test unitari (1.416 verdi al 05/08/2026), fra cui i guardiani
