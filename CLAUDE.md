...
- [ ] **Test** — mantieni `pytest` verde (**958 verdi** al 28/07/2026); aggiungi
...
python -m pytest                       # test (958 verdi al 28/07/2026)
```
...
tests/           test unitari (958 verdi al 28/07/2026), fra cui i guardiani
