...
- [ ] **Test** — mantieni `pytest` verde (**906 verdi** al 28/07/2026); aggiungi
...
python -m pytest                       # test (906 verdi al 28/07/2026)
```
...
tests/           test unitari (906 verdi al 28/07/2026), fra cui i guardiani
