...
- [ ] **Test** — mantieni `pytest` verde (**934 verdi** al 28/07/2026); aggiungi
...
python -m pytest                       # test (934 verdi al 28/07/2026)
```
...
tests/           test unitari (934 verdi al 28/07/2026), fra cui i guardiani
