...
- [ ] **Test** — mantieni `pytest` verde (**1.201 verdi** al 01/08/2026); aggiungi
...
python -m pytest                       # test (1.201 verdi al 01/08/2026)
```
...
tests/           test unitari (1.201 verdi al 01/08/2026), fra cui i guardiani
