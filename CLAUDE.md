...
- [ ] **Test** — mantieni `pytest` verde (**1.469 verdi** al 08/08/2026); aggiungi
...
python -m pytest                       # test (1.469 verdi al 08/08/2026)
```
...
tests/           test unitari (1.469 verdi al 08/08/2026), fra cui i guardiani
