...
- [ ] **Test** — mantieni `pytest` verde (**1.747 verdi** al 16/08/2026); aggiungi
...
python -m pytest                       # test (1.747 verdi al 16/08/2026)
```
...
tests/           test unitari (1.747 verdi al 16/08/2026; il ROSSO su
