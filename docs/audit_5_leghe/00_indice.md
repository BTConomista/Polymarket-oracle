...
- **`pytest` è sempre restato verde.** Il conteggio, però, è cresciuto molto: va
  ...
  | **oggi** (28 luglio 2026, Fase 118) | **913** | ✅ **ri-misurato in questa sessione**: `python -m pytest -q` → `913 passed`. I 72 in più vengono dalle Fasi 103-118 (Betfair, `ou_close_probability`, calendari di coppa, raccoglitore Smarkets e i suoi controlli di plausibilità) |
