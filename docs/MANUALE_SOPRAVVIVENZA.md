...
**Non ancora testati**: `betexplorer.com`, `oddsportal.com` (presumibilmente
bloccati; testare prima di pianificare scraping dall'ambiente — dal runner
Actions sono comunque liberi).
