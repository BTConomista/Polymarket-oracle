...
| ⭐ **diretta.it / Flashscore** (97 statistiche **per giocatore-partita**) — **2 raccolte**: Serie A 2025-26 e **Premier League 2025-26** | `files/diretta_{lega}_{stagione}/` (versionate; Serie A 11.894×108 + Premier 11.492×108, ognuna col proprio `manifesto.json`) | ⚠️ **il primo dato Tier B del progetto**, e l'unico con una **posizione di licenza dichiaratamente NON risolta**: dato a monte di **Opta**, raccolto **a mano** dall'utente (niente scraping), inserito su sua decisione consapevole il 31/07/2026. **Non rivendichiamo alcuna licenza.** Copertura: Serie A 379/380, **Premier 380/380**. Join ai nostri snapshot verificato **758/758** e **760/760**, coerenza dei gol idem — **1.518 controlli, 1.518 passati**. Insieme fanno **759 partite**, sopra la soglia di potenza della Fase 98. Tutte le 97 colonne sono `post` (regola R8). Leggere `files/diretta_serie_a_2526/README.md` |
