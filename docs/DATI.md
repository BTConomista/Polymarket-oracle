...
| ⭐ **diretta.it / Flashscore** (97 statistiche **per giocatore-partita**, Serie A 2025-26) | `files/diretta_serie_a_2526/` (versionata, 868 KB: `partita_per_partita.csv.gz` 11.894×108, `riepilogo_stagionale.csv.gz`, `legenda.csv`) | ⚠️ **il primo dato Tier B del progetto**, e l'unico con una **posizione di licenza dichiaratamente NON risolta**: dato a monte di **Opta**, raccolto **a mano** dall'utente (niente scraping), inserito su sua decisione consapevole il 31/07/2026. **Non rivendichiamo alcuna licenza.** Copertura 379/380 partite; join ai nostri snapshot verificato **758/758 = 100%** e coerenza dei gol **758/758 = 100%**. Tutte le 97 colonne sono `post` (regola R8). Leggere `files/diretta_serie_a_2526/README.md` |
