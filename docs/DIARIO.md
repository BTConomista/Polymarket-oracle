...
- [Fase 130 — Le statistiche di squadra per periodo: il primo dato che separa i due tempi](#fase-130--le-statistiche-di-squadra-per-periodo-il-primo-dato-che-separa-i-due-tempi)
...
## Fase 130 — Le statistiche di squadra per periodo: il primo dato che separa i due tempi
...
`files/README_statistiche_squadra.md`. **28 test nuovi, 1.162 verdi** (erano
1.130). Il manifesto si chiama `manifesto_squadra.json` e non `manifesto.json`
