# DFL-Supercup 2025-26 — Supercoppa di Germania
...
tf.squadre("dfl_supercup", periodo="Totale")
```

**1 partita** (16/08/2025) — VfB Stuttgart – Bayern München.

- **2025-08-16** (Finale) — Stuttgart – Bayern Munich
...
`tf.fonti("dfl_supercup")` → `('SofaScore',)`.
...
Dichiarate in `tf.colonne_vuote("dfl_supercup")`, e non sono un difetto unico:
