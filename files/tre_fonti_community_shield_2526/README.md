# Community Shield 2025-26 — FA Community Shield
...
tf.squadre("community_shield", periodo="Totale")
```

**1 partita** (10/08/2025) — Crystal Palace – Liverpool.

- **2025-08-10** (Finale) — Crystal Palace – Liverpool
...
`tf.fonti("community_shield")` → `('SofaScore',)`.
...
Dichiarate in `tf.colonne_vuote("community_shield")`, e non sono un difetto unico:
