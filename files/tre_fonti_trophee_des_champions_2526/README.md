# Trophée des Champions 2025-26 — Supercoppa di Francia
...
tf.squadre("trophee_des_champions", periodo="Totale")
```

**1 partita** (08/01/2026) — Paris Saint-Germain – Olympique de Marseille.

- **2026-01-08** (Finale) — Paris SG – Marseille
...
`tf.fonti("trophee_des_champions")` → `('SofaScore',)`.
...
Dichiarate in `tf.colonne_vuote("trophee_des_champions")`, e non sono un difetto unico:
